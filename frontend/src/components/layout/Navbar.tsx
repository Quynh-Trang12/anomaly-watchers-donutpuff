...
export const Navbar: React.FC = () => {
  const { role, setRole, userId, setUserId, setHasActivelySelectedUser } = useAuth();
      ...
      <div className="w-full max-w-[1600px] mx-auto px-4 sm:px-8 flex h-16 items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-2 ml-1 pl-3 border-l">
            ...
            <div className={`h-9 w-9 rounded-full flex items-center justify-center border-2 transition-all shrink-0 ${
              role === "ADMIN" ? "bg-primary text-primary-foreground border-primary shadow-lg shadow-primary/20" : "bg-primary/10 text-primary border-primary/20"
            }`}>
