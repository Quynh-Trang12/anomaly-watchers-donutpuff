  ...
  const team = [
    {
      name: "Dung",
      role: "Project Lead",
      bio: "Directs the team to successfully deliver the application.",
    },
    {
      name: "Trang",
      role: "UI Designer",
      bio: "Creates the visual interface layouts for AnomalyWatchers application users.",
    },
    {
      name: "Vy",
      role: "Backend Lead",
      bio: "Builds the secure server infrastructure powering the AnomalyWatchers system.",
    },
    {
      name: "Hien",
      role: "ML Strategist",
      bio: "Trains artificial intelligence models using datasets for anomaly detection.",
    },
  ];
  ...
  const features = [
    {
      ...
      desc: "Modeling trillions of data points to identify minute shifts in transaction patterns.",
    },
    {
      icon: <Zap />,
      title: "Instant Verification",
      desc: "Near-zero latency scoring with out-of-band Step-Up authentication triggers.",
    },
    {
      icon: <Cpu />,
      title: "Proprietary Engine",
      desc: "The Donutpuff-RF ensemble model delivers enterprise-grade precision in under 50ms.",
    },
  ];
    ...
    <Layout>
      <div className="container py-20 max-w-6xl">
        <header className="text-center mb-24">
          <div className="bg-primary/10 text-primary px-4 py-1.5 rounded-full inline-flex items-center gap-2 text-xs font-black uppercase tracking-widest mb-6">
          ...
          <p className="text-xl text-muted-foreground font-medium max-w-3xl mx-auto leading-relaxed">
            AnomalyWatchers is a state-of-the-art fraud detection workbench
            designed to bridge the gap between complex machine learning and
        ...
        <section className="grid grid-cols-1 md:grid-cols-3 gap-10 mb-32">
          <div className="p-10 bg-card border-2 rounded-[3rem] shadow-sm transform hover:-translate-y-2 transition-transform">
            ...
            <p className="text-muted-foreground font-medium text-sm leading-relaxed">
              Eliminate predictive friction and secure high-velocity transaction
              flows through autonomous behavioral intelligence.
            </p>
          </div>
          <div className="md:col-span-2 grid grid-cols-2 gap-6">
            <StatBox label="Transactions Protection" value="100%" />
              ...
              <div className="relative z-10">
                ...
                <div className="flex flex-wrap gap-2">
                  {[
                    ...
                    <span
                      key={tech}
                      className="px-4 py-2 bg-background border rounded-xl text-xs font-black shadow-sm"
                    >
                      {tech}
                    </span>
                  ))}
                ...
                <div className="mt-10 p-6 bg-primary text-primary-foreground rounded-2xl shadow-xl">
                  <p className="font-black italic text-sm">
                    "The architecture represents a paradigm shift in
                    transactional security, blending OOB authorization with
        ...
        <section className="text-center mb-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-5">
            {team.map((member, i) => (
              <div
                key={i}
                className="p-8 bg-card border rounded-[2.5rem] shadow-sm hover:shadow-xl transition-all"
              >
                ...
                <p className="text-primary font-black text-[10px] uppercase tracking-widest mb-4 italic">
                  {member.role}
                </p>
...
function StatBox({ label, value }: { label: string; value: string }) {
  return (
    <div className="p-8 bg-muted/20 border rounded-3xl flex flex-col justify-center items-center text-center group hover:bg-primary transition-colors cursor-default">
      <h4 className="text-4xl font-black tracking-tighter group-hover:text-primary-foreground transition-colors">
        {value}
      </h4>
      <p className="text-[10px] font-black uppercase text-muted-foreground group-hover:text-primary-foreground/70 tracking-widest mt-2">
        {label}
      </p>
    </div>
  );
